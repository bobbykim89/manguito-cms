...
- **A branded label/storage type system** remains a Stage 2 prerequisite, so the compiler rather than a reviewer catches the next site that mixes the two key spaces.
